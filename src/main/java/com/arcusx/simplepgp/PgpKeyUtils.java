 ...
 *
 * It is subject to the license terms in the LICENSE file found in the top-level directory of this distribution and at https://github.com/arcusx/simplepgp/blob/master/LICENSE.
 */
...
class PgpKeyUtils {
	public static PGPPublicKey readPublicKey(InputStream keyFile) throws IOException, PGPException {
		return PGPUtils.readPublicKey(keyFile);
//		InputStream in = null;
//		try {
